...
<a href="index2.php" class="btn btn-primary" style="margin:10px">Click here to go back to the login page</a>
    ...
    $find_hackman=mysqli_query($con,"SELECT * FROM bookfound")  or die( mysqli_error($con));
...
<?php  
 ...
 {  
      ...
      $query = "INSERT INTO tb2_images(name) VALUES ('$file')";  
 ...
 ?>  
                ...
                <?php  
                $query = "SELECT * FROM tb2_images ORDER BY id DESC";  

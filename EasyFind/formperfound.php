...
<a href="index2.php" class="btn btn-primary" style="margin:10px">Click here to go back to the login page</a>
    ...
    $find_hackman=mysqli_query($con,"SELECT * FROM perfound") or die( mysqli_error($con)); 
...
<?php  
 ...
 {  
      ...
      $query = "INSERT INTO tb8_images(name) VALUES ('$file')" or die( mysqli_error($con));  
 ...
 <html>  
      <head>  
           ...
           <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>  
                ...
                <?php  
                $query = "SELECT * FROM tb8_images ORDER BY id DESC";  
